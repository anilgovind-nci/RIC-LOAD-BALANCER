...
class RedisHandler {
  ...
  async update(key, lambdaKey, changeValue) {
    try {
      console.log("inside redis update received change value is:",changeValue);
      this.counter +=1;
      ...
      if (existingData && existingData.ActiveLambdas[lambdaKey]) {
        ...
        // }
        // else{
        //   console.log("inside update, key, lambdaKey, changeValue")
        //   existingData.ActiveLambdas[lambdaKey].AverageTimeToCompleteExecution = 0
        // }
        await this.create(key, existingData);
        return existingData;
      } else {
